...
total_epochs = 4
minibatch_size = 7500
learning_rate_blue = 2.5e-4
learning_rate_red = 2.5e-4
...
lmbda = 0.94                                # "lmbda" is the standard spelling in TorchRL (not "lambda")
epsilon = 0.02                              # entropy coefficient
